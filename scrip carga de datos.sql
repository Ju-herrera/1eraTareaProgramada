...
DECLARE @inRutaXML NVARCHAR(500) = 'C:\new\DatosXMLProgra.xml'
...
INSERT INTO dbo.Usuario
           ([UserName]
           ,[Password])/*Inserta en la tabla TipoDocIdent*/
SELECT *
...
INSERT INTO dbo.Articulo
           ([IdClaseArticulo]
           ,[Nombre]
		   ,[Precio])/*Inserta en la tabla TipoDocIdent*/
SELECT Ca.id , artx.Nombre, artx.precio 
...
on Ca.Nombre = artx.ClasesdeArticulo
